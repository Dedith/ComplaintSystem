...
Revision ID: 4feff673b41e
Revises: 
Create Date: 2023-02-20 19:28:12.444265
...
def upgrade() -> None:
    ...
    sa.Column('status', sa.Enum('pending', 'approved', 'rejected', name='state'), nullable=False, server_defaul='pending'),
